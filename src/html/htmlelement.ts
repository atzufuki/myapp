...
export default class AlexiHTMLElement<T = unknown> extends HTMLElement {
  ...
  props: Partial<HTMLElementProps<T>>;

  constructor(props?: Partial<HTMLElementProps<T>>) {
    super();
    this.props = props ?? {};
  }
   ...
   * @returns {Partial<HTMLElementProps>} Partial props.
   */
  getDefaultProps(): Partial<HTMLElementProps<T>> {
    return {};
  }
